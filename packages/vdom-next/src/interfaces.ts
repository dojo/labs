...
import { Evented, EventType, EventObject } from '@dojo/framework/core/Evented';
 ...
 * Wrapper for `w`
 */
export interface WNode<W extends WidgetBaseTypes = DefaultWidgetBaseInterface> {
	/**
 ...
 */
export type DNode<W extends WidgetBaseInterface<WidgetProperties, any> = any> =
	| VNode
	| WNode<W>
	| undefined
	| null
